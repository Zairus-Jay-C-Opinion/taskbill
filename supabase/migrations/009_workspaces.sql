-- ─── Create tables first, policies after (both tables must exist before cross-referencing) ───
...
-- workspaces: accepted members can read
