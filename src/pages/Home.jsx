...
const PLANS = [
  {
    ...
    features: ["Up to 3 clients", "20 tasks / month", "5 invoices / week", "Stripe payment links", "Email support"],
  ...
  },
  {
    ...
    features: ["Unlimited clients", "Unlimited tasks & invoices", "AI invoice drafting", "Priority support"],
